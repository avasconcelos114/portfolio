<template>
  <div class="experience post-card">
    <div class="experience__header">
      ...
      <span
        v-if="experience.city.length > 0 && experience.country.length > 0"
        class="experience__location"
        >{{ experience.city }}, {{ experience.country }}</span
      >
      <span
        v-if="experience.from.length > 0 && experience.until.length > 0"
        class="experience__timeline"
        >{{ experience.from }} ~ {{ experience.until }}</span
      >
    </div>
    ...
    <div class="post-tags">
      <span
        ...
        v-on:click="scrollToSkill(skill)"
        v-bind:key="skill"
